        ...
        <div class="contact-container">
            ...
            <p>For any inquiries, please contact us at:</p>
                <div class="col-container">  
                    ...
                    <input type="hidden" id="created_by" name="get_user_id" value="{{ Auth::id() ?? '' }}" />
                    @csrf
                        ...
                        <h5>What can we help you?</h5><textarea id="subject" name="description" placeholder="Write something.."></textarea>
